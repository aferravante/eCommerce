...
//        servizi.acquistaProdotto(acquisto, new Prodotto(1), 2);
//        servizi.acquistaProdotto(acquisto, new Prodotto(3), 1);
//        servizi.acquistaProdotto(acquisto, new Prodotto(4), 3);
//        servizi.acquistaProdotto(acquisto, new Prodotto(7), 1);
