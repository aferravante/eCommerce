...
public class VoceAcquistoDAOspringJdbcImpl extends JdbcDaoSupport implements VoceAcquistoDAO{
    ...
    public void delete(Acquisto acquisto) {
        getJdbcTemplate().update(JdbcUtility.DELETE_ACQUISTO_IN_VOCIACQUISTO, acquisto.getIdAcquisto());
    }

    @Override
    public void deleteAll() {
        getJdbcTemplate().update(JdbcUtility.DELETE_ALL_IN_VOCIACQUISTO);
    }
